...
typedef struct {
    ...
    float * d_pRem, *d_MatAux, *d_ones; //d_MatAux is a n_readsxn_prot matrix used in the intermediary steps in the calculation. d_ones has a vector of ones of size max(n_prot,n_sparsity,n_reads).
